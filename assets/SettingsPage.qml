...
Page
{
    ...
    {  
        ...
        Container
        {
            ...
            PersistCheckBox
            {
                text: qsTr("Load Cache") + Retranslate.onLanguageChanged
                key: "loadCache"
            }
            ...
            PersistDropDown
            {
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_theme_bright.png"
                    value: "bright"
                }
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_theme_dark.png"
                    value: "dark"
                }
            ...
            PersistDropDown
            {
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_font_default.png"
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_font_small.png"
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_font.png"
                ...
                Option {
                    ...
                    imageSource: "images/dropdown/ic_font_large.png"
